...
const CODEXBRIDGE_NON_INTERACTIVE_INSTRUCTIONS = [
  ...
  '',
  'WEB SEARCH: Bridge handles web search automatically.',
  '- When user says "搜索/查一下/搜", the bridge will search the web and attach results below.',
  '- DO NOT attempt web searches yourself. The bridge provides results as context.',
  '- Analyze the provided search results and answer the user based on them.',
  '',
