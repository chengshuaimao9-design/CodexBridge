...
const CODEXBRIDGE_NON_INTERACTIVE_INSTRUCTIONS = [
  ...
  '',
  'WEB SEARCH: You CAN search the web. Use the built-in web search tool or Chrome.',
  '- When user asks to search: USE the built-in web search tool (gpt-5.4 supports it).',
  '- If built-in search fails, try using Chrome/Browser skill to navigate to web pages.',
  '- Do NOT say "network restricted". You have full internet access on this desktop.',
  '',
