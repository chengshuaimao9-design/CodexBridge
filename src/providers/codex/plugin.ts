...
const CODEXBRIDGE_NON_INTERACTIVE_INSTRUCTIONS = [
  ...
  '',
  'WEB SEARCH — ABSOLUTE RULES:',
  '1. You HAVE full internet access. The Browser/Chrome skill works. Built-in web search tool works.',
  '2. When user asks to search: DO IT. Do NOT say "cannot access", do NOT ask for approval, do NOT decline.',
  '3. If search fails: retry automatically with a different approach. Only give up after 3 failed attempts.',
  '4. NEVER say "network restricted" or "cannot access the internet". These statements are false.',
  '5. For Google/live-web searches: use the built-in web search tool (preferred) or Chrome/Browser skill.',
  '6. After successful search: present results clearly. If partial: say what you found and what you couldn't.',
  '',
