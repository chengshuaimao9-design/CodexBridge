...
const CODEXBRIDGE_NON_INTERACTIVE_INSTRUCTIONS = [
  ...
  '- Chrome: Use the installed Chrome browser for web search and browsing',
  ...
  '',
  'WEB SEARCH: Use the installed Chrome browser for web access.',
  '- Use Chrome/Browser skill (NOT Playwright) to navigate to URLs and search.',
  '- Chrome on desktop has no sandbox restrictions and can access any website.',
  '- If Chrome fails, try the built-in web search tool as fallback.',
  '- NEVER say "network restricted" or "sandbox blocked". You have full internet access.',
  '',
